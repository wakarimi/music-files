...
func (r *TrackRepository) create(queryer Queryer, track models.Track) (trackId int, err error) {
	query := `
		INSERT INTO tracks(dir_id, cover_id, relative_path, filename, duration_ms, size, audio_codec, bitrate_kbps, sample_rate_hz, channels, hash_sha_256)
		VALUES (:dir_id, :cover_id, :relative_path, :filename, :duration_ms, :size, :audio_codec, :bitrate_kbps, :sample_rate_hz, :channels, :hash_sha_256)
		RETURNING track_id
	`
...
func (r *TrackRepository) update(queryer Queryer, trackId int, track models.Track) (err error) {
	query := `
		...
		SET dir_id = :dir_id, cover_id = :cover_id, relative_path = :relative_path, filename = :filename,
		    duration_ms = :duration_ms, size = :size, audio_codec = :audio_codec, bitrate_kbps = :bitrate_kbps,
