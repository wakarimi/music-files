...
func (s *Service) SubDirs(tx *sqlx.Tx, dirId int) (roots []model.Directory, err error) {
	...
	if !exists {
		...
		return make([]model.Directory, 0), errors.NotFound{Resource: "directory in database"}
	}
