...
func (u UseCase) DeleteRoot(input DeleteRootInput) (output DeleteRootOutput, err error) {
	...
	if err != nil {
		...
		return DeleteRootOutput{}, err
	}

	return output, nil
}

func (u UseCase) deleteRoot(tx *sqlx.Tx, input DeleteRootInput) (output DeleteRootOutput, err error) {
